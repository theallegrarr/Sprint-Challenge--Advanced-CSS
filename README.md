...
- This would imply 62.5% of the root element font-size

4. How would you describe preprocessing to someone new to CSS?
- Preprocessing is a concept that allows you to generate more versatile and compact CSS code - with some additional features not available to native CSS - using tools known as Preprocessors

5. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
- favorite: mixins, troublesome: nesting 
